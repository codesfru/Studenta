...
from vexana import telethn as bot
from vexana.modules.urluploader import download_file
from vexana.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By *VexanaRobot*",
            )
        except Exception as e:
            traceback.print_exc()
