...
import vexana.modules.sql.global_bans_sql as gban_sql
import vexana.modules.sql.users_sql as user_sql
from vexana import DEV_USERS, OWNER_ID, dispatcher
from vexana.modules.helper_funcs.chat_status import dev_plus
