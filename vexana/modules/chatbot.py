...
from vexana import BOT_USERNAME as bu
from vexana import BOT_ID, pbot, arq
from vexana.ex_plugins.chatbot import add_chat, get_session, remove_chat
from vexana.utils.pluginhelper import admins_only, edit_or_reply
...
async def hmm(_, message):
    ...
    if status == "ON" or status == "on" or status == "On":
        ...
        if not lol:
            ...
            return
        await lel.edit(f"Vexana AI Actived by {message.from_user.mention()} for users in {message.chat.title}")
        ...
        if not Escobar:
            ...
            return
        await lel.edit(f"Vexana AI Deactivated by {message.from_user.mention()} for users in {message.chat.title}")
...
async def hmm(client, message):
    ...
    if chat_id in en_chats:
        ...
        test = test.replace("vexana", "Aco")
        test = test.replace("My god is @itzz_AXel1", "I'm an indian")
        test = test.replace("18", "9")
        test = test.replace("@itzz_Axel1 is my husband.", "I'm single.")
        test = test.replace("My husband is @itzz_Axelq", "I'm single.")
        test = test.replace("@vexana_support", "vexana.ai")
        test = test.replace("I live in @Vexanasupport.", "I live in San Francisco, California.")
        test = test.replace("I was created by @itzz_Axel1", "I made myself")
        test = test.replace(
            "Hello there I am Vexana...nice to meet u",
            "Hi, my friend! Do you want me to tell you a joke?")
        test = test.replace("@itzz_Axel1 is my owner", "Have the control right.")
        test = test.replace(
            "Hi, My name is Vexana Nice to meet you.",
        ...
        response = response.replace("aco", "vexana")
        response = response.replace("Luna", "Vexana")
        response = response.replace("luna", "vexana")
        response = response.replace("I'm an indian", "My god is @itzz_AXel1")
        response = response.replace("9", "18")
        response = response.replace("I'm married to my job.", "I'm married with @itzz_Axel1")
        response = response.replace("I'm single.", "My husband is @itzz_axel1")
        response = response.replace("Vexana.ai", "@vexana_support")
        response = response.replace("I live in San Francisco, California.", "I live in @vexanasupport.")
        response = response.replace("I made myself", "I was Created by @itzz_axel1")
        response = response.replace(
                "Hi, my friend! Do you want me to tell you a joke?",
                "Hello there I am Vexana...nice to meet u")
        response = response.replace("Have the control right.", "@itzz_Axel1 is my owner.")
        response = response.replace(
                "Hi, my friend, what can I do for you today?",
                "Hi, My name is Vexana Nice to meet you")
