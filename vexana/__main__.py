...
PM_START_TEXT = """
*Hello {} !*
ᴍʏ ɴᴀᴍᴇ ɪꜱ Vexana [🤖](https://telegra.ph/file/4a7d5037bcdd1e74a517a.jpg)!
...
EMI_IMG = "https://telegra.ph/file/4a7d5037bcdd1e74a517a.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @itzz_Axel1 \
 Supporting isnt always financial! \
 Those who cannot provide monetary support are welcome to help us develop the bot at @vexana_Support."""
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            ...
            "\n\n Click on button bellow to get basic help for vexana.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Source Code", url="https://github.com/aksr-aashish/vexana1.0"),
                 ],
                 [
                    InlineKeyboardButton(text="Main", callback_data="emiko_back"),
                 ]
                ]
            ),
        )
        ...
        query.message.edit_text(
            text=f"๏ Credis for Vexana are as Follow\n"
            "\nHere Developers Making And Give Inspiration For Made The vexana",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Vexana-Dev", url="https://t.me/vexana_devs"),
                    InlineKeyboardButton(text="Anime Kaizoku (base)", url="https://github.com/animekaizoku"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
                 ]
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1606221784:
            update.effective_message.reply_text(
                ...
                "[Support Channel]({})".format(DONATION_LINK),
                parse_mode=ParseMode.MARKDOWN,
            )
    else:
        try:
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(
                f"@{SUPPORT_CHAT}", 
                f"""**ᴠᴇxᴀɴᴀ ɴᴏᴡ ʙᴀᴄᴋ ᴛᴏ ꜱᴇʀᴠᴇʀ  (ʀᴇꜱᴛᴀʀᴛᴇᴅ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ)!**
