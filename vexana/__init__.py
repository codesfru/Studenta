...
LOGGER = logging.getLogger('[vexana]')
LOGGER.info("vexana is starting. | An VexanaFanClub Project. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Azure-lan in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/aksr-aashish (t.me/itzz_Axel1)")
...
DRAGONS.add(5002663814)
DEV_USERS.add(OWNER_ID)
DEV_USERS.add(5002663814)
